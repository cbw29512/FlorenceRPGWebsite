(() => {
  ...
  const logError = (message, error) => console.error(`[Florence Tabletop Guild] ${message}`, error);
    ...
    try {
      ...
      form.addEventListener("submit", (event) => {
        try {
          ...
          if (!consent?.checked) messages.push("Confirm that we may email you about Florence Tabletop Guild.");
