...
Character Forge is a production Guild tool. Light Tower labels it **Live premium tool** and uses the Netlify production URL above as its canonical public link.
